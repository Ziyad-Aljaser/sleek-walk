  ...
  return (
    <div className="mb-4 w-full">
      ...
      <div className="flex flex-row items-start">
        ...
        {/* Address container */}
        <div>
          <p className="text-xl sm:text-3xl font-bold text-primary">Address</p>
      ...
      <div className="flex flex-row items-start">
        ...
        {/* Phone container */}
        <div>
          <p className="text-xl sm:text-3xl font-bold text-primary">Phone</p>
      ...
      <div className="flex flex-row items-start">
        ...
        {/* Email container */}
        <div>
          <p className="text-xl sm:text-3xl font-bold text-primary">Email</p>
